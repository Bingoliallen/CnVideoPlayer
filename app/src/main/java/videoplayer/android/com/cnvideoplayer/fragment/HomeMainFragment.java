...
public class HomeMainFragment extends BaseFragment implements OnTabSelectListener {
                        ...
                        if (mBaseEntity != null) {
                            if (mBaseEntity.getStatus() == 100) {
                                ...
                                if (mUserInfo != null && mUserInfo.getResult() != null && mUserInfo.getResult().getItems()!=null) {
                                    ...
                                    tabLayout_3.setOnTabSelectListener(HomeMainFragment.this);
