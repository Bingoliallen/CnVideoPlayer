        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                switch (CURRENT_NETWORK_STATE) {
                    case -1:
                        LogUtil.d("网络更改为 无网络  CURRENT_NETWORK_STATE =" + CURRENT_NETWORK_STATE);
                        break;
                    case 1:
                        LogUtil.d("网络更改为 WIFI网络  CURRENT_NETWORK_STATE=" + CURRENT_NETWORK_STATE);
                        break;
                    case 2:
                        LogUtil.d("网络更改为 移动网络  CURRENT_NETWORK_STATE =" + CURRENT_NETWORK_STATE);
                        break;
